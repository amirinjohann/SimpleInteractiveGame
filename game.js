...
function drawDialogue() {
  ...
  // Remove the instruction prompt at the bottom of the dialogue box
  // if (typewriterDone) {
...
const introLines = [
  ...
  '',
  'they say the forest was once alive — not with animals or insects..',
  'but with memory',
  '',
  'People who wandered in, came back different... if they came back at all.',
  '',
  'Your journey begins at the edge of the woods,',
  "Contemplating your next move. 'What brought me to this place?' ",
  'Craving for answers.',
  '',
  '',
